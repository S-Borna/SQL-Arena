          ...
          <div className="max-w-2xl">
            <div className="mb-6">
              ...
              <div className="flex gap-2 mt-3">
                {selectedExercise.courseGoals.map(id => (
                  <span key={id} className="px-2 py-0.5 bg-zinc-800 text-cyan-400 text-xs rounded font-mono">
                    Kursmål {id}
                  </span>
                ))}
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-200 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full h-32 px-3 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-200 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-cyan-500"
              />
            </div>
        ...
        <div className="w-80 p-4 bg-zinc-900/30 overflow-auto">
          ...
          <div className="space-y-4 text-xs">
            <div className="p-3 bg-zinc-800/50 rounded-lg">
              <h4 className="font-semibold text-cyan-400 mb-2">1NF (Första normalformen)</h4>
            ...
            <div className="p-3 bg-zinc-800/50 rounded-lg">
              <h4 className="font-semibold text-cyan-400 mb-2">2NF (Andra normalformen)</h4>
              <ul className="space-y-1 text-zinc-400">
                <li>• Uppfyller 1NF</li>
            ...
            <div className="p-3 bg-zinc-800/50 rounded-lg">
              <h4 className="font-semibold text-cyan-400 mb-2">3NF (Tredje normalformen)</h4>
              <ul className="space-y-1 text-zinc-400">
                <li>• Uppfyller 2NF</li>
  ...
  return (
    <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        <button
          onClick={handleAdd}
          className="px-2 py-1 bg-cyan-500 text-zinc-950 font-medium rounded text-sm hover:bg-cyan-400"
        >
          +
        </button>
      </div>

...
export const hanukkahMysteries: Exercise[] = [
  ...
  // LEVEL 3: Hanukkah Mystery - Ljus 1-2
  {
    ...
    level: 3,
    category: 'where',
    title: 'Ljus 1: Kunden med ljusen',
    brief: 'Hitta kunden vars telefonnummer slutar på 2024.',
    database: 'hanukkah',
    expectedColumns: ['name', 'phone'],
    hints: ['Använd LIKE med % i början för att matcha slutet', 'Mönster: %2024'],
    solution: "SELECT name, phone FROM customers WHERE phone LIKE '%2024'",
    courseGoals: [1],
    difficulty: 'beginner'
  },
  {
